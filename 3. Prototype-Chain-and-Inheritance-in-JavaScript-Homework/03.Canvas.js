var i, canvas, ctx, acceptedCharacters;
...
function isValidHexColor(colorToCheck) {
    ...
    for (i = 1; i < colorToCheck.length; i++) {
        if (acceptedCharacters.indexOf(colorToCheck[i].toLocaleLowerCase()) < 0) {
            return false;
        }
...
function areValidArguments(args) {
...
var Shapes = (function() {
    var Shape = (function() {
        function Shape(x, y, color) {
            if (arguments.length !== 3 || !areValidArguments(arguments)) {
    ...
    var Circle = (function() {
        function Circle(x, y, color, radius) {
            if (arguments.length !== 4 || !areValidArguments(arguments)) {
                throw new Error('There is missing or incorrect argument!');
            }
    ...
    var Rectangle = (function() {
        function Rectangle(x, y, color, width, height) {
            if (arguments.length !== 5 || !areValidArguments(arguments)) {
                throw new Error('There is missing or incorrect argument!');
            }
    ...
    var Triangle = (function() {
        function Triangle(x, y, color, x2, y2, x3, y4) {
            if (arguments.length !== 7 || !areValidArguments(arguments)) {
                throw new Error('There is missing or incorrect argument!');
            }
